...
<body class="easyui-layout">
	...
	<SCRIPT type="text/javascript">
		...
		var zNodes =[
			...
			{ id:11, pId:1, name:"北京分公司",_url:'/framework/admin/user/list.htm?orgId=1'},
			{ id:12, pId:1, name:"上海分公司",_url:'/framework/admin/user/list.htm?orgId=2'}
		...
		function onClick(event, treeId, treeNode, clickFlag) {
			...
			$("#user_frame").attr("src",treeNode._url);
			return false;
		}	
