		...
		<div style="padding:10px 60px 20px 60px">
	    	...
	    	<table cellpadding="5">
	    		...
	    		<tr>
	    			...
	    			<td>
	    			<select id="userType" name="userType" class="easyui-combobox"  data-options="width:140,panelHeight:'auto'" >
	    				<option value="A">管理员</option>
	    				<option  value="P" selected>应用</option>
	    			</select>
	    			</td>
	    		</tr>
	    		<tr>
	           ...
	           <table cellpadding="5">
	    		...
	    		<tr>
	    			<td align="right">其他:</td>
	    				<td><input class="easyui-validatebox textbox" type="text" id="emply_other" name="emply.other" data-options="validType:['maxLength[512]']"></input></td>
	    		</tr>
